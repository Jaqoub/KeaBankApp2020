...
import static com.example.keabankapp.Logic.SavingAndReadingFiles.readFileInternalStorage;
import static com.example.keabankapp.Logic.SavingAndReadingFiles.updatefile;
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if (daystopay == 0 || Long.toString(daystopay).contains("-")) {
                        ...
                        if (transfermoney.getResponse() == 200) {
                            jsonArray.remove(i);
